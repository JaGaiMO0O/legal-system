    ...
    const cases: MotorLiabilityCase[] = [
      {
        id: 'ml-1',
        caseNo: 'ML-2026-101',
        courtType: 'General Civil Court',
        courtLevel: 'Primary',
        courtCity: 'Riyadh',
        caseDescription:
          'Three-car chain collision with bodily injury and vehicle loss assessment.',
        claimantName: 'Fahad Al-Anzi',
        nationality: 'Saudi',
        gender: 'Male',
        age: 34,
        ...
        percentMoralPhysical: '15% Moral, 30% Physical',
        totalClaimedAmount: 185000,
        totalPaidAmount: 60000,
        dateOfInsertion: toIso(-40),
        periodFrom: toIso(-40),
        periodTo: toIso(35),
        hearingsCourtType: 'General Civil Court',
      ...
      },
      {
        ...
        courtCity: 'Jeddah',
        caseDescription:
          'Pedestrian injury claim after crosswalk impact at controlled intersection.',
        claimantName: 'Raghad Al-Sobhi',
        nationality: 'Saudi',
        gender: 'Female',
        age: 28,
        ...
        profession: 'Teacher',
        damageType: 'Fatal',
        percentMoralPhysical: '100% Moral, 0% Physical',
